    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this Amazing Deal of ${car.year} ${car.make} ${car.model} on ICON CARS!`,
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            <DialogTrigger className="w-full text-start">
              <Card className="pt-5 cursor-pointer hover:bg-slate-100">
                <CardContent>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:contact@iconcars.com">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">ICON CARS</h4>
